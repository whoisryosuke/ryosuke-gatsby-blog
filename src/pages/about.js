        ...
        return (
            <Layout className="About pt2">
                <Box px={3} py={5} sx={{borderBottom:"1px solid black"}}>
                  <Heading fontSize={[1,2,3]}>Ryosuke meaning <Highlight>clear</Highlight> mediation.</Heading>
                  <Heading fontSize={[4,5,6]}>
                    The artist formerly known as <Highlight>Oscar</Highlight> <Image src={ BombEmoji } alt="Bomb emoji" width="40px" />
                  </Heading>
                </Box>
                <Flex px={3} py={5} sx={{borderBottom:"1px solid black"}} flexWrap="wrap">

                    <Box as="figure" width={[1,1,1/3]} textAlign="center">
                        <Image src={RyosukePortrait} 
                          sx={{
                            width: [ '100%', '50%' ],
                            borderRadius: 8,
                          }} />
