...
[react-gamepad-context-with-options](https://codesandbox.io/s/react-gamepad-context-with-options-cuwdh)
...
[react-gamepad-menu (w/ controller UI) (hook version - working)](https://codesandbox.io/s/react-gamepad-menu-w-controller-ui-hook-version-working-nktve?file=/src/App.js)
